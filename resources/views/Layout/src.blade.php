...
<body>
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
              ...
              <a class="flex ml-2 md:mr-24" href="index.html">
                ...
                <span class="self-center text-xl sm:text-2xl whitespace-nowrap dark:text-white">𝓨𝓸𝓾𝓻𝓤𝓷𝓲𝓿𝓮𝓻𝓼𝓮</span>
              </a>
            </div>
      ...
      <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-60 h-screen pt-20 transition-transform -translate-x-full bg-white sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
          ...
          <ul class="space-y-2 font-medium">
            <li>
              <a href="/" class="flex items-center p-2 text-gray-500 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                <svg class="w-6 h-6 text-gray-500 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
            ...
            <li>
              <a href="/search" class="flex items-center p-2 bg-gray-300 dark:bg-gray-600 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group">
                <svg class="w-5 h-5 text-black transition duration-75 dark:text-white group-hover:text-gray-900 dark:group-hover:text-white"  aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
            ...
            <li>
              <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Massage</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <!-- body content -->
      <div class="coba-src sm:ml-60 flex bg-gray-200 dark:bg-black justify-center " >
        @yield('coba-src')
      </div>  
      <!-- Akkhir content -->
