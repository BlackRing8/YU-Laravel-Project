      ...
      <div class="rounded-lg dark:border-gray-700 mt-14 mb-24" data-aos="fade-up">
        ...
        <div id="controls-carousel" class="relative w-full" data-carousel="static">
          ...
          <div class="relative h-56 overflow-hidden rounded-lg  md:h-96">
              ...
              <a href="" class="hidden duration-700 ease-in-out" data-carousel-item>
                  <div class="flex flex-wrap bg-white dark:bg-black h-44 w-full rounded-xl">
                      ...
                      <div class=" w-52">
                        ...
                        <h1 class="ml-3 dark:text-yellow-200">Penulis</h1> 
                        <h1 class="ml-3 dark:text-yellow-200">Tipe</h1> 
                        <h1 class="ml-3 dark:text-yellow-200">Genre</h1> 
                        <h1 class="ml-3 dark:text-yellow-200">Status</h1> 
                      </div>
                  </div>
              </a>
              {{-- cover 2 --}}
              ...
              <a href="" class="hidden duration-700 ease-in-out" data-carousel-item>
                <div class="flex flex-wrap bg-white dark:bg-black h-44 w-full rounded-xl">
                    <img src="image/cover/enhel.jpeg" class="w-32 h-44 rounded-xl">
                    <div class=" w-52">
                      <h1 class="font-bold text-xl ml-3 mt-2 flex dark:text-yellow-200">Judul Buku</h1>
                      <h1 class="ml-3 dark:text-yellow-200">Penulis</h1> 
                      <h1 class="ml-3 dark:text-yellow-200">Tipe</h1> 
